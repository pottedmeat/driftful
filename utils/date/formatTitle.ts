import { format, isToday, isTomorrow, isYesterday, isSameMonth, isSameYear, getYear } from 'date-fns';
 ...
 */
export function formatTitle(startDate: Date | null, endDate: Date | null): string {
